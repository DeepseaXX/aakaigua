...
相比FF14自带的dlss版本，至少dlss 4也就是Present K开始，画质有了非常明显的提升。国际服不需要这样修改，国服默认不支持，所以需要使用这个方法启用修改选项。

本文使用的修改方法参照[NGA帖子](https://bbs.nga.cn/read.php?pid=816049181&opt=128)
